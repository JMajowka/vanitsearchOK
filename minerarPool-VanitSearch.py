...
parser.add_argument("--pool-token", default=os.getenv("POOL_TOKEN"), required=False, help="8ce1e93decc9309baf2e52edfb97ac618a31629436d4b2a0d3bf25969384b28c")
parser.add_argument("--base-url", default="https://bitcoinpuzzles.io/api/block", help="https://bitcoinflix.replit.app/api/big_block")
